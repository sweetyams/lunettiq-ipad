...
const styles = StyleSheet.create({
  ...
  suggestionCard: { backgroundColor: Colors.white, borderWidth: 1, borderColor: Colors.border, borderRadius: 2, overflow: 'hidden', position: 'relative' as const, flexDirection: 'row' as const },
  suggestionActions: { position: 'absolute' as const, top: 6, right: 6, zIndex: 10, flexDirection: 'row', gap: 4 },
  suggestionActionBtn: { width: 28, height: 28, borderRadius: 14, backgroundColor: 'rgba(0,0,0,0.6)', alignItems: 'center', justifyContent: 'center' },
  suggestionActionText: { color: Colors.white, fontSize: 14 },
  suggestionImg: { width: 80, height: 80, backgroundColor: Colors.cream },
  suggestionBody: { flex: 1, padding: 8, justifyContent: 'center' as const },
  suggestionTitle: { fontSize: 13, fontWeight: '600', color: Colors.navy },
  suggestionMeta: { fontSize: 11, color: Colors.muted, marginTop: 2 },
  reasonRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 4, marginTop: 4 },
  reasonBadge: { backgroundColor: Colors.primaryLight, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 2 },
  reasonText: { fontSize: 10, fontWeight: '500', color: Colors.primary },
